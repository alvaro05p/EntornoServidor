...
if (isset($_GET['enviar'])) {
    ...
    if (!empty($situacion)) {
        echo "<b>Situación:</b> " . strtoupper(implode(" – ", $situacion)) . "<br>";
    } else {
        echo "<b>Situación:</b> No seleccionada<br>";
    }
...
<body>
    <h1>Alumnos - Formulario de registro 2</h1>
    <form action="form2.php" method="get">
        ...
        <select name="situacion[]" multiple size="2">
