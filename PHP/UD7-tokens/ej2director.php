...
<body>
        <h1>Bienvenido a la pagina del director</h1>
        <h3>Tus datos:</h3>
        <ul>
        ...
        <form action="ej2director.php" method="POST">

            <button type="submit" class="btn btn-danger" name="cerrar">Cerrar sesión</button>
            <button type="submit" class="btn btn-danger" name="cambiar_SID">Cambiar SID</button>
